...
const JobDetailsPD = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header Section */}
      <section
        className="text-center py-16 sm:py-20 px-6 flex flex-col items-center"
        style={{
          background:
            "linear-gradient(151deg, rgba(254, 248, 255, 0.50) 8.45%, rgba(227, 236, 255, 0.50) 45.2%, rgba(205, 202, 255, 0.50) 101.49%)",
        }}
      >
        <h1 className="text-zinc-900 font-sen text-[28px] sm:text-4xl md:text-5xl mt-12 font-normal leading-[140%] tracking-[-1.44px]">
          Product Designer
        </h1>
        <p className="text-zinc-500 font-figtree text-lg font-normal leading-[160%] mt-6 max-w-xs">
          We are looking for a mid-level product designer to join our team
        </p>

        <button className="md:hidden text-lg font-figtree font-semibold mt-6 px-7.5 py-3.5 w-62.5 leading-[175%] rounded-full bg-zinc-900 text-white flex items-center justify-center gap-2 hover:bg-blue-600">
        ...
        <button className="hidden text-lg font-figtree font-semibold mt-16 px-7.5 py-3.5 leading-[175%] rounded-full bg-zinc-900 text-white md:flex items-center gap-2 hover:bg-blue-600">
          Apply Now <Icon icon="mage:arrow-up-right" width="20" height="20" />
        </button>
      </section>

      {/* Description Section */}
      <main className="max-w-3xl mx-auto text-left py-15 sm:py-16 text-zinc-700 font-figtree">
        <section className="mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-2xl font-figtree text-zinc-900 text-center font-medium leading-[135%] tracking-[-0.96px] mb-4">
            Job description
          </h2>
          <p className="text-zinc-500 text-[18px] font-normal leading-[160%] px-4 sm:px-6 md:px-8">
        ...
        <section className="mb-8 sm:mb-10">
          ...
          <ul className="list-disc list-inside text-lg space-y-2 text-zinc-500 px-4 sm:px-6 md:px-8">
            <li>
      ...
      <div className="flex justify-between items-center max-w-3xl mx-auto pb-15 sm:pb-4 mb-2 border-t border-zinc-200 pt-10 sm:pt-12 px-4 sm:px-6 md:px-8 lg:px-0">
        <a
